...
loadingCompleteText.Text = "Hi Lô Mài!!"
...
DeveloperAccesText.Text = "Dev Is Ah Huy Admin"
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://17004189232";
      Title = "Z-azure Hub Hub", 
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://17004189232"
...
ImageButton1.Image = "rbxassetid://17004189232" -- ảnh button ở ngoài --
...
---------------------------------- Các Tab
local Library = Update:Window("Z-azure Hub","",Enum.KeyCode.RightControl);
...
Dis:AddLabel("SCRIPT Z-azure Hub HUB V2 UPDATE")
...
Dis:AddLabel("Fluxus, DeltaX, Codex, Hydrogen, Wave....")
...
M:AddToggle("Get Cursed Dual Katana",_G.AutoCdk,function(value)
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "rbxassetid://17064720747"..tostring(logo)
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Size = UDim2.new(0, 50, 0, 50)
		imagenoti.BackgroundTransparency = 1
		imagenoti.Image = "rbxassetid://17004189232"..tostring(logo)
...
Sea:AddToggle("Auto Drive",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    Sea:AddToggle("Auto Summon Mirage Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Troll:AddButton("Effect Z-azure Hub",function()
...
Troll:AddButton("Z-azure Hub! Duma Troll Vi en:>",function()
...
wait(1)
local ID =17004189232 --Này Là Id Ảnh Nha Ní :>>>
...
sound.SoundId = "rbxassetid://17064720747"--Này là nhạc
sound:Play()
sound.Looped = true
repeat
wait(1)
